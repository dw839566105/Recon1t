...
for i in radius:
    ...
    data1.append(np.mean(recon[r<0.6,3]))
    data2.append(np.mean(recon[:,3]))
...
plt.legend()
plt.title('Recon Smulation Energy, Truth: 2 MeV')
...
for i in radius:
    ...
    r = np.linalg.norm(recon[:,:3], axis=1)
    data1.append(np.mean(recon[r<0.6,3]))
    err1.append(np.std(recon[r<0.6,3]))
    data2.append(np.mean(recon[:,3]))
    err2.append(np.std(recon[:,3]))
    
#plt.plot(radius, data, '.', linewidth=1.5, label = 'Sum of hits', alpha = 0.5)
#plt.plot(radius, data1,'.', label = 'SH recon with cut r<0.6 m', alpha = 0.5)
#plt.plot(radius, data2,'.', label = 'SH recon without cut', alpha = 0.5)

plt.errorbar(radius, data, err, marker='s', label = 'Sum of hits', alpha = 0.5, ms=2, mew=4)
plt.errorbar(radius, data1, err1, marker='s', label = 'SH recon with cut r<0.6 m', alpha = 0.5, ms=2, mew=4)
...
for i in radius:
    ...
    if(i==0):
        ...
        test.append(recon[:,3]/nml) 
    else:
        test.append(recon[:,3]/nml)

plt.boxplot(test, positions=np.array(np.arange(len(test)))*50, sym='', widths=30)

plt.xlabel('radius/mm')
plt.ylabel('Energy/MeV')
plt.title('Boxplot of Recon Energy')
plt.show()
...
for i in radius:
    ...
    if(i==0):
        ...
        err1.append(np.std(recon[r<0.6,3]/nml1))
        test.append(recon[:,3]/nml1)
        #data2.append(np.mean(recon[:,3]/nml))
        #err2.append(np.std(recon[:,3]))
plt.figure(dpi=300)
plt.plot(radius, np.array(data)-2,'.', label='Scaled total PE', alpha=0.5)
plt.plot(radius, np.array(data1)-2,'.', label='SH recon (cut: r<0.6m)', alpha=0.5)
plt.xlabel('Radius/mm')
plt.ylabel('Energy bias/MeV')
plt.legend()
plt.show()
plt.figure(dpi=300)
plt.plot(radius, np.array(err1),'.', label='Scaled totl PE', alpha=0.5)
plt.plot(radius, np.array(err),'.', label='SH recon (cut: r<0.6m)', alpha=0.5)
plt.xlabel('Radius/mm')
plt.ylabel('Energy bias/MeV')
plt.legend()
plt.show()
...
for i in radius:
    ...
    err.append(np.std(E/nml))
    h.close()
    recon = loadE('../result_1t_point_axis_Recon_1t_new2/1t_+%.3f_x.h5' % i)*1000
    r = np.linalg.norm(recon[:,:3], axis=1)
...
plt.savefig('Box_rr_x.pdf')
plt.show()
print(np.array(np.arange(len(test)))*20)
...
plt.legend()
plt.savefig('Recon_r_bias_x.pdf')
plt.show()
...
plt.savefig('Recon_r_resolution_x.pdf')
plt.show()
...
plt.savefig('Recon_vertex_bias_cut_x.pdf')
plt.show()
...
plt.savefig('Recon_vertex_bias_x.pdf')
plt.show()
...
plt.savefig('Recon_vertex_resolution_cut_x.pdf')
plt.show()
...
plt.savefig('Recon_vertex_resolution_x.pdf')
plt.show()
...
plt.legend()
plt.savefig('Recon_r_bias_z.pdf')
plt.show()
...
plt.savefig('Recon_r_resolution_z.pdf')
plt.show()
...
plt.savefig('Recon_vertex_bias_cut_z.pdf')
plt.show()
...
plt.savefig('Recon_vertex_bias_z.pdf')
plt.show()
...
plt.savefig('Recon_vertex_resolution_cut_z.pdf')
plt.show()
...
plt.savefig('Recon_vertex_resolution_z.pdf')
plt.show()
...
plt.figure(dpi=300)
plt.plot(radius, np.array(data) - 2, '.', label = 'Scaled total PE', alpha = 0.5)
plt.plot(radius, np.array(data1) - 2, '.', label = 'SH recon with cut r<0.6 m', alpha = 0.3)
#plt.errorbar(radius, data2, err2, marker='s', label = 'SH recon without cut', alpha = 0.5, ms=2, mew=4)
...
plt.legend()
plt.title('Recon Energy of Smulation data, z axis, Truth: 2 MeV')
plt.savefig('Energy_z_bias.pdf')

plt.figure(dpi=300)
plt.plot(radius, np.array(err), '.', label = 'Scaled total PE', alpha = 0.5)
plt.plot(radius, np.array(err1), '.', label = 'SH recon with cut r<0.6 m', alpha = 0.3)
#plt.errorbar(radius, data2, err2, marker='s', label = 'SH recon without cut', alpha = 0.5, ms=2, mew=4)
...
plt.legend()
plt.title('Recon Energy of Smulation data, z axis, Truth: 2 MeV')
plt.savefig('Energy_z_resolution.pdf')
...
plt.legend()
plt.title('Recon Energy of Smulation data, x axis, Truth: 2 MeV')
plt.savefig('Energy_x_resolution.pdf')


# In[13]:


radius = np.arange(0.00, 0.61, 0.01)
mean = np.zeros_like(radius)
std = np.zeros_like(radius)
for index, r in enumerate(radius):
    h = tables.open_file('../test_E/%.3f_z.h5' % r)
    EE = h.root.Recon[:]['E_sph_in']
    if(index==0):
        nml = np.mean(EE[EE>0.01])/2
    mean[index] = np.mean(EE[EE>0.01]/nml)
    std[index] = np.std(EE[EE>0.01]/nml)       
...
plt.errorbar(radius, data, err, marker='s', alpha = 0.5, ms=2, mew=4, label='Scaled total PE')
plt.errorbar(radius, mean, std, marker='s', alpha = 0.3, ms=2, mew=4, label='SH recon with truth vertex')
plt.xlabel('Radius/m')
plt.ylabel('Energy/MeV')
plt.legend()
plt.title('Recon Energy of Smulation data, z axis, Truth: 2 MeV')
...
h = tables.open_file('../test_E/0.000_z.h5')
plt.hist(h.root.Recon[:]['E_sph_in'],bins=30)
plt.show()
...
h = tables.open_file('../result_1t_point_axis_Recon_1t_new2/1t_+0.000_x.h5')
recondata = h.root.Recon
E1 = recondata[:]['E_sph_in']
x1 = recondata[:]['x_sph_in']
y1 = recondata[:]['y_sph_in']
...
y = np.zeros(0)
z = np.zeros(0)
for run in np.arange(257,265):
    path = '/mnt/eternity/Jinping_1ton_Data/Recon/run00000%d/' % run
